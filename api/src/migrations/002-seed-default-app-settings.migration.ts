...
const DEFAULT_SUPPORT_FAQ_PAGE_VALUE = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: "انتخاب محصول، مدل و رنگ، آپلود عکس فضا و پیش‌نمایش واقع‌گرایانه.",
      items: [
        {
        ...
        },
        {
          ...
          answer:
            "ابتدا محصول، مدل و رنگ دلخواه را از کاتالوگ فروشگاه انتخاب کنید. سپس از اتاق، پذیرایی، آشپزخانه یا هر فضای دیگر عکس بگیرید یا آپلود کنید. AI فقط محصولات انتخابی شما را در تصویر فضای واقعی قرار می‌دهد و پرسپکتив، نور و چیدمان را حفظ می‌کند.",
        },
        {
          id: "products-locked",
        ...
        {
          id: "products-catalog",
          question: "چه نوع محصولاتی در فروشگاه موجود است؟",
          answer:
...
<article>
  <h2>Smart Furnish</h2>
  <p>
    Smart Furnish فروشگاه هوشمند مبلمان و دکوراسیون منزل است. در کاتالوگ ما مبلمان، فرش، تلویزیون، آشپزخانه، نمای دیوار، دکور و سایر عناصر طراحی داخلی را پیدا می‌کنید.
  </p>
  <p>
    مدل و رنگ دلخواه هر محصول را انتخاب کنید، از اتاق، پذیرایی، آشپزخانه یا هر فضای دیگر عکس بگیرید یا آپلود کنید — هوش مصنوعی فقط محصولات انتخابی شما از کاتالوگ فروشگاه را در تصویر فضای واقعی شما قرار می‌دهد و پرسپектив، نور و چیدمان را حفظ می‌کند.
  </p>
  <h3>امکانات اصلی</h3>
  <ul>
    <li>مرور کاتالوگ محصولات با جزئیات مدل، رنگ و مشخصات.</li>
    <li>پیش‌نمایش واقع‌گرایانه با AI در عکس فضای منزل شما.</li>
  ...
  <h3>هدف ما</h3>
  <p>
    کمک به شما برای انتخاب مطمئن‌تر دکوراسیون — قبل از خرید ببینید محصول انتخابی در فضای واقعی منزلتان چگونه خواهد بود.
  </p>
</article>
`.trim();
