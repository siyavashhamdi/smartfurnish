export const VERIFY_EMAIL_SUBJECT = "تأیید ایمیل — @@@<APP_NAME>@@@";
...
<div dir="rtl" style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;font-size:1px;line-height:1px;">
  برای تأیید ایمیل خود در @@@<APP_NAME>@@@ به @@@<VERIFICATION_URL>@@@ مراجعه کنید.
</div>
<style>
  @font-face {
    font-family: "B Yekan";
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" dir="rtl" style="max-width:560px;background-color:#ffffff;border:1px solid #eadde3;border-radius:16px;overflow:hidden;direction:rtl;">
        <tr>
          <td align="center" style="background-color:#c9567e;padding:32px 32px 28px">
            ...
            <div style="margin-top:10px;font-size:15px;font-weight:500;color:rgba(255,255,255,0.92);font-family:'B Yekan',Vazirmatn,Arial,sans-serif;">تأیید ایمیل</div>
          </td>
        </tr>
        <tr>
          <td dir="rtl" style="padding:36px 32px 8px;text-align:right;direction:rtl;font-family:'B Yekan',Vazirmatn,Arial,sans-serif;">
            <h1 style="margin:0 0 10px;font-size:22px;font-weight:700;color:#3d2c35;line-height:1.5;text-align:right;">تأیید آدرس ایمیل</h1>
            <p style="margin:0 0 28px;font-size:15px;line-height:1.9;color:#5c4d55;text-align:right;">
              سلام <strong style="color:#3d2c35">@@@<USER_FIRST_NAME>@@@</strong>، برای تکمیل تنظیمات حساب خود در <strong style="color:#3d2c35">@@@<APP_NAME>@@@</strong> لطفاً ایمیل خود را تأیید کنید.
            </p>
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:0 auto 8px">
              <tr>
                <td align="center" style="border-radius:10px;background-color:#c9567e">
                  <a href="@@@<VERIFICATION_URL>@@@" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;font-family:'B Yekan',Vazirmatn,Arial,sans-serif;">تأیید ایمیل</a>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:24px 0 0;font-size:14px;line-height:1.85;color:#7a6872;text-align:right;">
              پس از تأیید ایمیل می‌توانید از تمام امکانات سامانه استفاده کنید.
            </p>
          </td>
        </tr>
        <tr>
...
export function isLegacyVerifyEmailTemplate(html: string): boolean {
  return html.includes("logo.png") || html.includes("@@@<ACTIVATION_URL>@@@");
}
