export const PRODUCT_AI_PREVIEW_BUTTON_LABEL = "مـشـاهــده هـوشـمـنــد مـبـــل در خانـــه مـــن";
export const PRODUCT_AI_PREVIEW_GENERATE_LABEL = "ساخت پیش‌نمایش هوشمند";
export const IN_PERSON_VISIT_BUTTON_LABEL = "ثبت رایگان درخواست بازدید حضوری محصول";
export const PRODUCT_AI_PREVIEW_RESULT_DISCLAIMER =
...
export const PRODUCT_AI_PREVIEW_REGISTERED_FINAL_STEP_SHORT_LABEL = "تأیید";
export const PRODUCT_AI_PREVIEW_RESULT_EMPTY_MESSAGE = "موردی برای نمایش وجود ندارد.";
export const PRODUCT_AI_PREVIEW_RESULT_EMPTY_HINT =
  "برای دیدن نتیجه در این صفحه، به مرحله «پیش‌نمایش» برگردید، پارچه و عکس فضای خود را تکمیل کنید و پیش‌نمایش هوشمند بسازید.";
